...
IMG ?= zachaller/argoproj-metrics-poc:latest
...
.PHONY: generate
generate: gen-openapi controller-gen ## Generate code containing DeepCopy, DeepCopyInto, and DeepCopyObject method implementations.
